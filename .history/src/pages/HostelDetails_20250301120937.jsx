...
const HostelDetails = () => {
  ...
  return (
    <div className="p-6">
      ...
      <p className="mt-4">
        Our hostel offers a comfortable and welcoming environment with clean housekeeping services, high-speed WiFi, and air-conditioned rooms. We strive to provide a home away from home for all our residents.
      </p>
    </div>
  );
};
