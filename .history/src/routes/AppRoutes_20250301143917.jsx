...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="/payment" element={<ProtectedRoute roles={['admin', 'resident']}><Payment /></ProtectedRoute>} />
      <Route path="/Hostel-details" element={<ProtectedRoute roles={['admin', 'resident']}><HostelDetails /></ProtectedRoute>} />
      <Route path="/maintenance" element={<ProtectedRoute roles={['admin', 'resident']}><Maintenance /></ProtectedRoute>} />
      ...
      <Route path="/reports" element={<ProtectedRoute roles={['admin', 'resident']}><Reports /></ProtectedRoute>} />
      ...
      <Route path="/create-room" element={<ProtectedRoute roles={['admin']}><CreateRoom /></ProtectedRoute>} />
    </Routes>
  );
};
